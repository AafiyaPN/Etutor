			...
			<div class="span9">
				<div class="hero-unit-3">
						...
						while($subject_row = mysql_fetch_array($subject_query))
						{
							...
							?>
							<td><a rel="tooltip" title="View notes" class="btn btn-info" href="download.php<?php echo "?sid=".$sub_id."&&tid=".$tid; ?>">View Notes     <i class="icon-file-alt icon-large"></i></a></td></tr></div>
							<?php
							}
							?>
