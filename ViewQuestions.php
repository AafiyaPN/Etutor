                ...
                <div class="hero-unit-3">
					<form method="post">
						...
						$c=$_SESSION['count'];
							...
							<tr>
								<td><div>A. <input type="radio" name="option" value="<?php echo $row['option1']; ?>"  > 	<?php echo $row['option1']; ?> </div></br></td>
							</tr>
							<tr>
								<td><div>B. <input type="radio" name="option" value="<?php echo $row['option2']; ?>"> 	<?php echo $row['option2']; ?>  </div></br></td>
							</tr>
							<tr>
								<td><div>C. <input type="radio" name="option" value="<?php echo $row['option3']; ?>"> 	<?php echo $row['option3']; ?> </div></br></td>
							</tr>
							<tr>
								<td><div>D. <input type="radio" name="option" value="<?php echo $row['option4']; ?>"> 	<?php echo $row['option4']; ?> </div></br></td>
							</tr>
							<tr>
