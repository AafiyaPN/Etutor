            ...
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li><a href="#benefits" rol="button" data-toggle="modal"><i class="icon-list-alt icon-large"></i>&nbsp;Benifits
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div> 
                            </a></li>
    ...
    <div class="container">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="row-fluid">
                    <div class="span17">
                        <div class="alert alert-success"><i class="icon-file icon-large"></i>&nbsp;<strong>E-LEARNING MISSION</strong></div>
                        <div class="hero-unit-2">
                            E-LEARNING is a unique learning environment developed specifically to help students achieve the best possible grades in their exams. It works by providing students with online access to concise coverage of theory and helps at times in the year when extra support is needed, it’s winning formula for exam success, used by individual students, schools and colleges across the world. E-LEARNING effectively promotes students learning and can increase student knowledge in specific subjects and topics through targeted components detailed in each lesson module. It aids in increasing basic academic skills such as reading, spelling, history, science, and mathematics and assists in the process of evaluating and synthesizing information </div>
