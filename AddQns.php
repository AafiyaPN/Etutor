				...
				<form class="form-horizontal" method="post">
                    <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered" id="example">
						...
						<tr>
							...
							<td><div><input type="text" name="txtQpc" placeholder="Question Paper code"/></div><?php echo "<br>";?></td></tr>
							<tr>
							...
							<td><div><input type="text" name="txtQst" /></div></td></tr>
							<tr>
							<td><div>Enter Options</div></td>
							<td><div><input type="text" name="txtOpt1" placeholder="First Option"/></div>
							<div><input type="text" name="txtOpt2" placeholder="Second Option" /></div>
							<div><input type="text" name="txtOpt3" placeholder="Third Option" /></div>
							<div><input type="text" name="txtOpt4" placeholder="Last Option" /></div></td></tr>
							<tr>
							<td><div>Enter Answer</div></td>
							<td><div><input type="text" name="txtAns" placeholder="Answer"/></div></td></tr>
							<tr>
							<td><div></div></td>
